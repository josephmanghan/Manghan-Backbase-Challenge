...
- If a customer attempts to make a savings account withdrawal, but no funds available, the card is "declined" and the transaction is removed from the ledger
